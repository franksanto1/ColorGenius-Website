...
const tiers: Tier[] = [
  {
    ...
    features: [
      ...
      { label: 'The Master · unlimited throughout', included: true, group: 'unlimited' },
  ...
  },
  {
    ...
    features: [
      ...
      { label: '100 Master sessions per month', included: 'a master colorist beside you — quick questions or deep dives', group: 'capacity' },
  ...
  },
  {
    ...
    features: [
      { label: 'Essentials-level features per seat', included: '25 FCs · Unlimited Reformulations · Unlimited try-ons · 100 Master sessions' },
  ...
  },
  {
    ...
    features: [
      { label: 'Pro-level features per seat', included: '50 FCs · Unlimited Reformulations · Unlimited try-ons · 200 Master sessions' },
  ...
  },
  {
    ...
    features: [
      { label: 'Premium-level features per seat', included: '75 FCs · Unlimited Reformulations · unlimited try-ons · 300 Master sessions · unlimited client profiles' },
...
export const askVersaniPacks = [
  {
    ...
    size: 25,
    price: 2.99,
    label: 'Top-Up 25 Master sessions',
  ...
  },
  {
    ...
    size: 50,
    price: 4.99,
    label: 'Top-Up 50 Master sessions',
  ...
  },
  {
    ...
    size: 100,
    price: 7.99,
    label: 'Top-Up 100 Master sessions',
  ...
  },
  {
    ...
    size: 300,
    price: 14.99,
    label: 'Top-Up 300 Master sessions',
...
export function SalonCalculator() {
  ...
  const planMeta: Record<TeamPlanKey, { label: string; description: string; tab: string }> = {
    teamEssentials: {
      ...
      description: '25 FCs/seat · Unlimited Reformulations · Unlimited try-ons · 100 Master sessions + Team Dashboard. For salons starting out.',
    },
    teamPro: {
      tab: 'Team Pro',
      label: 'Team Pro · Pro-level features per seat',
      description: '50 FCs/seat · Unlimited Reformulations · Unlimited try-ons · 200 Master sessions · Voice Texting team-wide + Team Dashboard. For full-time stylists.',
    },
    teamPremium: {
      tab: 'Team Premium',
