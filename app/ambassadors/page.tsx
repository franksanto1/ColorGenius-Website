...
export const metadata: Metadata = {
  ...
  description:
    'Join the Versani Founding Ambassador circle. Five to eight lifetime Premium seats, 20% lifetime affiliate revenue share, and permanent Founding status.',
  alternates: { canonical: '/ambassadors' },
  openGraph: {
    title: 'Versani Founding Ambassador Circle',
    description:
      'Five to eight slots. Lifetime Premium. 20% affiliate share. Founding status, permanently.',
    url: '/ambassadors',
    type: 'website',
  },
  twitter: {
    ...
    description:
      'Five to eight slots. Lifetime Premium. Founding status, permanently.',
  },
}
...
const youReceive = [
  {
    ...
    body: 'Full Premium tier — 70 consultations, 160 Formula Reformulations, correction tooling, custom templates, branded reports — for as long as Versani exists. No recurring fee, no renegotiation.',
  },
  {
...
const faqs = [
  ...
  },
  {
    ...
    a: 'Your Founding Ambassador status is permanent regardless of program growth. Lifetime Premium and the 20% affiliate share on already-referred accounts both persist. You are not tied to our upside.',
  },
]
          ...
          <div className="relative container text-center max-w-4xl">
            ...
            <Reveal delay={0.1}>
              <p className="mt-8 text-base md:text-lg text-[color:var(--muted-foreground)] leading-relaxed">
                Five to eight slots. Lifetime Premium. A permanent seat at
